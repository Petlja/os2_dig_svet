...
.. fillintheblank:: f120a
    ...
    | Најбржи пут од А до Д: |blank|
    | Пут са највећим бројем потеза од А до Ђ: |blank|
    | Пут са највећим бројем потеза од А до Д: |blank|
    | Пут од А до Г, избегавајући тачке В, Ђ, Е: |blank| 
    | Пут од Е до А избегавајући тачке Ж, Г, В, Д: |blank| 
...
Пре него што употребиш Бојанку, у радној свесци на страници **27** направи скицу постера или анимације.
...
Пажљиво прочитај тврђења. У радној свесци на страници **28** обој квадратић зеленом бојом испред тврђења које потврђује да наведено већ 
